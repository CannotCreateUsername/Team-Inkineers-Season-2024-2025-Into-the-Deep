...
public class RightAutoCoords {
    ...
    public Vector2d scoreSpecimenPos = new Vector2d(24.5 - X_OFFSET, 5);
    ...
    public Vector2d aroundSamplePos1 = new Vector2d(samplePos1.x+29 - X_OFFSET, samplePos1.y+4);
    public Vector2d aroundSamplePos2 = new Vector2d(samplePos2.x+29 - X_OFFSET, samplePos2.y+4);
