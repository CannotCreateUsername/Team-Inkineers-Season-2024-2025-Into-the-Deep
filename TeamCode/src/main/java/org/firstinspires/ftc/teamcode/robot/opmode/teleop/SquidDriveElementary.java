...
@TeleOp(name = "Elementary Drive", group = "Linear Opmode")
public class SquidDriveElementary extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ArmSubsystemTeleOp armSubsystem = new ArmSubsystemTeleOp(hardwareMap, false);
        ...
        while (opModeIsActive()) {
            ...
            armSubsystem.runSubsystemWithoutHang(gamepadEx1, gamepadEx2, gamepad1);
            ...
            telemetry.addLine();
            telemetry.addData("HANG TIMER", armSubsystem.getHangTime());
